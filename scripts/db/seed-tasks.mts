...
const templates:Template[]=[
 ...
 {key:'images',type:'image_clean',title:'篮球图片数据清洗',difficulty:1,
  ...
  config:{images:[{id:'basket-1',url:'/training/gen/basketball-1.png',description:'图片 1'},{id:'football-1',url:'/training/gen/football-1.png',description:'图片 2'},{id:'basket-2',url:'/training/gen/basketball-2.png',description:'图片 3'}]},
 ...
 {key:'bbox',type:'image_annotation',title:'图片方框标注：人物、动物和红灯',difficulty:2,
  ...
  config:{imageUrl:'/training/gen/traffic-scene.png',targetLabels:['人物','动物','红绿灯'],annotationTool:'bbox',attributes:{红绿灯:['红灯','绿灯']}},
 ...
 {key:'point',type:'point_annotation',title:'图片点标注：红绿灯中心点',difficulty:1,
  ...
  config:{imageUrl:'/training/gen/traffic-scene.png',targetLabels:['红绿灯'],annotationTool:'point',attributes:{红绿灯:['红灯','绿灯']}},
 ...
 {key:'polyline',type:'polyline_annotation',title:'图片线框标注：道路中线',difficulty:2,
  ...
  config:{imageUrl:'/training/gen/traffic-scene.png',targetLabels:['道路中线'],annotationTool:'polyline'},
 ...
 {key:'polygon',type:'polygon_annotation',title:'图片轮廓标注：动物',difficulty:2,
  ...
  config:{imageUrl:'/training/gen/traffic-scene.png',targetLabels:['动物'],annotationTool:'polygon'},
