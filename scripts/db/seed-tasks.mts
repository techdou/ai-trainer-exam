...
const templates:Template[]=[
 ...
 {key:'bbox2',type:'image_annotation',title:'图片方框标注：篮球与足球',difficulty:1,
  ...
  config:{imageUrl:'/training/basketball-1.png',targetLabels:['篮球','足球'],annotationTool:'bbox'},
 ...
 {key:'point2',type:'point_annotation',title:'图片点标注：篮球中心',difficulty:1,
  ...
  config:{imageUrl:'/training/basketball-2.png',targetLabels:['篮球'],annotationTool:'point'},
 ...
 {key:'polyline2',type:'polyline_annotation',title:'图片折线标注：草地分界线',difficulty:2,
  ...
  config:{imageUrl:'/training/football-1.png',targetLabels:['草地分界线'],annotationTool:'polyline'},
 ...
 {key:'polygon2',type:'polygon_annotation',title:'图片轮廓标注：篮球',difficulty:2,
  ...
  config:{imageUrl:'/training/basketball-1.png',targetLabels:['篮球'],annotationTool:'polygon'},
 ...
 {key:'poly-car',type:'polyline_annotation',title:'折线标注：汽车侧视轮廓线',difficulty:2,
  ...
  config:{imageUrl:'/training/gen/car-1.png',targetLabels:['汽车轮廓'],annotationTool:'polyline'},
 ...
 {key:'poly-dog',type:'polyline_annotation',title:'折线标注：小狗坐姿背线',difficulty:2,
  ...
  config:{imageUrl:'/training/gen/dog-solo-1.png',targetLabels:['小狗背线'],annotationTool:'polyline'},
 ...
 {key:'poly-cat',type:'polyline_annotation',title:'折线标注：猫咪坐姿中线',difficulty:2,
  ...
  config:{imageUrl:'/training/gen/cat-solo-1.png',targetLabels:['猫咪中线'],annotationTool:'polyline'},
 ...
 {key:'poly-mushroom',type:'polyline_annotation',title:'折线标注：蘑菇伞盖弧线',difficulty:1,
  ...
  config:{imageUrl:'/training/gen/mushroom-1.png',targetLabels:['蘑菇伞盖'],annotationTool:'polyline'},
 ...
 {key:'pgon-car',type:'polygon_annotation',title:'轮廓标注：汽车整体外轮廓',difficulty:2,
  ...
  config:{imageUrl:'/training/gen/car-1.png',targetLabels:['汽车'],annotationTool:'polygon'},
 ...
 {key:'pgon-dog',type:'polygon_annotation',title:'轮廓标注：小狗整体外轮廓',difficulty:3,
  ...
  config:{imageUrl:'/training/gen/dog-solo-1.png',targetLabels:['小狗'],annotationTool:'polygon'},
 ...
 {key:'pgon-cat',type:'polygon_annotation',title:'轮廓标注：猫咪整体外轮廓',difficulty:3,
  ...
  config:{imageUrl:'/training/gen/cat-solo-1.png',targetLabels:['猫咪'],annotationTool:'polygon'},
 ...
 {key:'pgon-mushroom',type:'polygon_annotation',title:'轮廓标注：蘑菇整体外轮廓',difficulty:1,
  ...
  config:{imageUrl:'/training/gen/mushroom-1.png',targetLabels:['蘑菇'],annotationTool:'polygon'},
