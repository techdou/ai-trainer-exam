...
export default function TeacherExamsPage(){
 ...
 const labels:Record<string,string>={draft:'草稿',published:'已发布',in_progress:'进行中',ended:'已结束',closed:'已关闭',results_pending:'待发布成绩',results_released:'成绩已发布',archived:'已归档'};
