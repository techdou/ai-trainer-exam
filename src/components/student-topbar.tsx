      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          <Link href="/student/home" className="flex items-center gap-2 shrink-0">
            ...
            <span className="font-bold text-lg hidden lg:inline whitespace-nowrap">人工智能训练师五级</span>
          </Link>
          <nav className="hidden md:flex items-center gap-0.5" aria-label="主导航">
            {links.map((l) => {
              ...
              return (
                <Link
                  ...
                  href={l.href}
                  className={cn(
                    'px-2.5 py-2 rounded-lg text-base font-medium whitespace-nowrap transition-colors',
