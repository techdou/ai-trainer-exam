 ...
 * 50 单选 + 40 判断 + 10 填空
 * 供 seed 脚本和 admin API 共享使用
 */

export type SingleChoiceQ = {
  type: 'single_choice';
  stem: string;
...
export type TheoryQuestion = SingleChoiceQ | TrueFalseQ | FillInBlankQ;
